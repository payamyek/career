  ...
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item{ \small{ Rebuilt Dockerfiles by configuring non-root users act as the active user, docker instructions  listed in the order that best takes advantage of layer caching, and using the smallest base images possible to minimize AWS ECR costs } }
       \resumeItemListEnd
