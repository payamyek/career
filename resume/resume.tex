...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://ca.linkedin.com/in/payamyek}{\faIcon{linkedin} linkedin.com/in/payamyek}  & Toronto, ON\\
  \href{https://github.com/payamyek}{\faIcon{github} github.com/payamyek} & \href{payamyek@gmail.com}{payamyek@gmail.com}\\
  \href{https://payamyek.ca}{\faIcon{laptop}  payamyek.com} & (647)-867-5038
\end{tabular*}
...
\section{Skills}
 \resumeSubHeadingListStart
 	\resumeSubItem{Languages}{Python, Java, C, Rust, JavaScript, TypeScript, SQL, Groovy, Haskell, Assembly}
 	\resumeSubItem{Web Technologies}{React.js, React Native, Vue, TailWind CSS, Bootstrap, CSS, SASS, SCSS, Expo, HTML }
 	\resumeSubItem{Database Technologies}{MongoDB, PostgreSQL, DocumentDB, Neo4J, SQLite}
 	\resumeSubItem{Cloud Technologies}{Amazon Web Services, DigitalOcean, Docker, Rancher }
 \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
   \resumeSubheading
      ...
      {Systems Developer}{(4 Mos) Sep. 2022 - Present}
      \resumeItemListStart
        \item{ \small{ Diligently remedied data consistency and integrity issues caused by the main database by carefully analyzing historical logs and data backups which led to the remediation of multiple bugs in core systems } }
    ...
    \resumeSubheading
      {Municipal Property Assessment Corporation}{Pickering, ON}
      {Junior Co-op Systems Developer}{(12 Mos) Jan. 2020 - Dec. 2020}
      \resumeItemListStart
        ...
        \item{\small{Brought a vision for the new MPAC Insight workflow to life by developing dashboard module prototypes using React.js that was powered by Ontario housing data which was well received by the team leads}}
       \resumeItemListEnd
  \resumeSubHeadingListEnd
